...
public class FramesPerSecond : MonoBehaviour
{
    ...
    private static FramesPerSecond _instance;
    public static FramesPerSecond instance => _instance ??= FindObjectOfType<FramesPerSecond>();
    ...
    void Update()
    {
        ...
        this.fpsSmooth += (fps - fpsSmooth) * 0.08f;

        // Update UI
        string text = texts.Aggregate((a, s) => a += $" {s} ") +
                      $"{msec,5:###.0} ms, {this.fpsSmooth:0} fps, {this.belowLimitCounter}";
